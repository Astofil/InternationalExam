...
public class ParticipantService
{
    ...
    public async Task<Response<List<GetParticipantDto>>> GetParticipant()
    {
        ...
        {
            return new Response<List<GetParticipantDto>>(System.Net.HttpStatusCode.InternalServerError, ex.Message);
        }
    ...
    public async Task<Response<AddParticipantDto>> AddParticipant(AddParticipantDto participant)
    {
        ...
        {
            return new Response<AddParticipantDto>(HttpStatusCode.InternalServerError, ex.Message);
        }
